...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <script src="<?=base_url()?>js/vendor/datatables/jquery.dataTables.js"></script>
    <script src="<?=base_url()?>js/vendor/datatables/dataTables.bootstrap4.js"></script>
