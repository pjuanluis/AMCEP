...
<html lang="en" class="no-js">
   ...
   <body onLoad="setupZoom()">
      ...
      <!-- End Banner Area -->
      <!-- Start About Area -->
      <section id="acerca" class="section-full gray-bg">
         <div class="container">
            ...
            <div class="row justify-content-center">
               <div class="col-lg-8">
                  <div class="product-area-title text-center">
                     <p class="text-uppercase">Nuestro Equipo</p>
                     <h2 class="h2">
                        El trabajo en equipo construye confianza y<br>la confianza construye el crecimiento.
                     </h2>
                  </div>
               </div>
            </div>
            <div class="row">
               <div class="col-lg-3 col-sm-6">
                  <div class="single-member">
                     <div class="thumb relative" style="background: url(<?=base_url()?>img/staff/1.jpeg);">
                     ...
                     <div class="desc text-center">
                        <h5 class="text-uppercase"><a href="#">Pamela Gómez Jordán</a></h5>
               ...
               <div class="col-lg-3 col-sm-6">
                  <div class="single-member">
                     <div class="thumb relative" style="background: url(<?=base_url()?>img/staff/2.jpeg);">
                        <div class="overlay overlay-member d-flex flex-column justify-content-end align-items-center">
               ...
               <div class="col-lg-3 col-sm-6">
                  <div class="single-member">
                     <div class="thumb relative" style="background: url(<?=base_url()?>img/staff/3.jpeg);">
                        <div class="overlay overlay-member d-flex flex-column justify-content-end align-items-center">
               ...
               <div class="col-lg-3 col-sm-6">
                  <div class="single-member">
                     <div class="thumb relative" style="background: url(<?=base_url()?>img/staff/4.jpeg);">
                        <div class="overlay overlay-member d-flex flex-column justify-content-end align-items-center">
      ...
      <!-- ZONA DE CURSOS -->
      <section id="cursos" class="section-full">
         <div class="container">
            <div class="row justify-content-center">
               <div class="col-lg-8">
                  <div class="product-area-title text-center">
         ...
         <div class="container">
            <div class="row justify-content-center">
               <div class="col-lg-8">
                  <div class="product-area-title text-center">
                     <p class="text-uppercase"></p>
                     <h2 class="h1">Cursos impartidos</h2>
                  </div>
               </div>
            </div>
            <div class="row">
      ...
      <!-- Start Contact Area -->
      <section id="contacto" class="section-full gray-bg">
         <div class="container">
            <div class="row justify-content-center">
               <div class="col-lg-8">
                  <div class="product-area-title text-center">
            ...
            <div class="row">
                  ...
                  <div class="row">
                     <div class="col-sm-6">
                        <div class="address mt-20">
                           <h6 class="text-uppercase mb-15">Dirección</h6>
                           <p><br> 
                              Avenida de los Insurgentes 601 <br>
                              Col. Nápoles Ciudad de México, DIF. 03810, México
                           </p>
                           <p>Tel.: 55 68 72 06 68</p>
                        </div>
                     </div>
                     <div class="col-sm-6">
                        <div class="address mt-20">
               ...
               <div class="col-lg-6 mt-30">
                  <form id="myForm" action="mail.php" method="post" class="contact-form">
                     ...
                     <div class="single-input color-2 mb-10">
                        <input type="email" name="email" placeholder="Correo Electrónico" pattern="[A-Za-z0-9._-]+@[A-Za-z0-9.-]+\.[A-Za-z]{1,63}$" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Correo Electrónico'" required>
                     </div>
                     <div class="single-input color-2 mb-10">
                        <input type="text" name="subject" placeholder="Asunto" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Asunto'" required>
                     </div>
                     <div class="single-input color-2 mb-10">
                        <textarea name="message" placeholder="Escribe tu mensaje..." onfocus="this.placeholder = ''" onblur="this.placeholder = 'Escribe tu mensaje...'" required></textarea>
                     </div>
      ...
      <script src="<?=base_url()?>js/FancyZoom/js-global/FancyZoom.js"></script>
      <script src="<?=base_url()?>js/FancyZoom/js-global/FancyZoomHTML.js"></script>
